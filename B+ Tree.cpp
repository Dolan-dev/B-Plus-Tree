...
void insertionMethod(BPTree** bPTree) {
    ...
    cout << "Provide the rollNo: ";
    cin >> rollNo;

    cout << "\nEnter the Name, Age and Marks: ";
    cin >> name >> age >> marks;
...
int main() {
    ...
    cout << "Provide the value to limit maximum child Internal Nodes can have: ";
    cin >> maxChildInt;
    cout << "\nEnter the maximum number of nodes Leaf Nodes can have: ";
    cin >> maxNodeLeaf;

    BPTree* bPTree = new BPTree(maxChildInt, maxNodeLeaf);

    do {
        cout << "\nProvide the queries with respective keys : " << endl;
